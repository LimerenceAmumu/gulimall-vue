  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="显示状态" prop="showStatus">
        <el-switch v-model.number="dataForm.showStatus" active-value=1 inactive-value=0 ></el-switch>
      </el-form-item>
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'showStatus': Number.parseInt(this.dataForm.showStatus),
